...
def eliminar_cotizacion(id):
    ...
    if ventas_relacionadas:
        ...
        return (
            ...
            "porque ya está relacionada con una venta.",
            400
        )
...
def pasar_a_venta(id):
    ...
    try:
        ...
        for clave, cantidad_necesaria in (
            necesidades.items()
        ):
